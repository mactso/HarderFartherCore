...
public class Network {
	...
	public static <MSG> void registerMessage(Class<MSG> msg, BiConsumer<MSG, FriendlyByteBuf> encoder,
			Function<FriendlyByteBuf, MSG> decoder, BiConsumer<MSG, Context> handler) {
